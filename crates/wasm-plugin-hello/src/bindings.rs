...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:component:wasm-plugin-hello:example:encoded world"
)]
#[doc(hidden)]
...
@\0\0s\x04\0\x0bhello-world\x01\0\x01@\x02\x01ay\x01by\0y\x04\0\x03add\x01\x01\x04\
\0#component:wasm-plugin-hello/example\x04\0\x0b\x0d\x01\0\x07example\x03\0\0\0G\
